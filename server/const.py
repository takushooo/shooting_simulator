...
PLAYER_SIZE = 20
# IDゼロ版はサーバーなので空にしておく
PLAYER_COLORS = ['', 'red', 'cyan', 'lawn green', 'white', 'coral', 'gold', 'thistle', 'azure', 'light grey']
...
BULLET_POINT = 1
BULLET_SIZE = 6
BULLET_COLORS = ['', 'red', 'cyan', 'lawn green', 'white', 'coral', 'gold', 'thistle', 'azure', 'light grey']
